...
class Ui_DialogCalibrate(object):
    def setupUi(self, DialogCalibrate):
        ...
        self.btnAoAWingTare.setGeometry(QtCore.QRect(260, 120, 161, 32))
        self.btnAoAWingTare.setObjectName("btnAoAWingTare")
        self.lblRawAoA = QtWidgets.QLabel(DialogCalibrate)
        self.lblRawAoA.setGeometry(QtCore.QRect(280, 40, 81, 21))
        font = QtGui.QFont()
        ...
        self.txtRawAirspeed.setGeometry(QtCore.QRect(150, 40, 56, 20))
        font = QtGui.QFont()
        font.setPointSize(18)
        ...
        self.btnAirspeedTare.setGeometry(QtCore.QRect(30, 90, 161, 32))
        ...
        self.btnAoAPlatformTare.setGeometry(QtCore.QRect(260, 80, 161, 32))
